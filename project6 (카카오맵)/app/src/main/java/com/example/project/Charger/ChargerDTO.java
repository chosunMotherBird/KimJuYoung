package com.example.project.Charger;
...
public class ChargerDTO {
    ...
    public ChargerDTO(Long id, String chargerName, String chargerLocation, String city, String closedDates, String fastChargeType, Integer slowNum, Integer fastNum, String parkingFee, Double lat, Double lon, String address)
    {
        this.id = id;
